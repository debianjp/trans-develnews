...
-------------------------------------------------
dpkg-gensymbols は，ライブラリパッケージ向け control
ファイル内の新しいシンボルを作るために使われます(同様に、さらに正確な依存関係を作るため
dpkg-shlibdepsでも使われます)。さらに詳細は、後ほど提供します。現在、ガイドラインに分かりやすい使用法を追記してくれるアーリーアダプターを募集中です。
さらに詳細情報は、以下をご参照ください。
